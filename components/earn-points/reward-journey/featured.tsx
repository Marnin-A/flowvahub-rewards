    ...
    <JourneyCard>
      <div className="p-4 bg-[linear-gradient(135deg,#9013FE_0%,#70D6FF_100%)] text-white relative overflow-hidden">
        ...
        <div className="flex items-center justify-between mt-6">
          ...
          <div className="overflow-hidden relative rounded-full size-10 md:size-16">
            <Image src="/images/reclaim.png" alt="reclaim" width={100} height={100} />
          </div>
        </div>
        <p className="text-lg">
      ...
      <div className="p-4">
        <div className="flex justify-start mb-4">
          <div className="w-6 h-6 mr-4 bg-[#eef2ff] rounded-[6px] flex items-center justify-center shrink-0 text-primary-purple">
            {/* <Image src="/icons/calendar-2.svg" alt="calendar" width={24} height={24} className="w-[24px] h-[24px]" /> */}
            <Calendar size={24} color="#9013FE" strokeWidth={2.5} className="animate-small-pulse-scale" />
          </div>
          <div className="flex-1">
            <h4 className="mb-1 font-semibold text-black">Automate and Optimize Your Schedule</h4>
            <p className="text-[0.875rem] text-gray-600">
              Reclaim.ai is an AI-powered calendar assistant that automatically schedules your tasks, meetings, and
              breaks to boost productivity. Free to try — earn Flowva Points when you sign up!
            </p>
          </div>
        </div>
      </div>
      <div className="px-4 py-[5px] flex justify-between items-center border border-t-[#f3f4f6] border-b-0 border-r-0 border-l-0">
        ...
        >
          <Image src="/icons/user-plus.svg" alt="user-plus" width={17.5} height={14} className="w-[17.5px] h-[14px]" />
          Sign up
        </Button>
        <Button
          onClick={openModal}
        ...
        >
          <Image src="/icons/gift.svg" alt="gift" width={14} height={14} className="w-[14px] h-[14px]" />
          Claim 50 pts
        </Button>
      </div>
      <Modal
      ...
      >
        <h2 className="text-2xl font-bold text-black text-center capitalize mb-4">Claim your 25 points</h2>
        <div className="ant-modal-body">
          ...
          <li className="text-[0.9rem] text-gray-3">
            ...
            <ul>2️⃣ Upload a screenshot of your Reclaim profile showing your email.</ul>
          </li>
          <p className="text-[0.9rem] text-gray-3">After verification, you’ll get 25 Flowva Points! 🎉😊</p>
          <form className="mt-3">
            ...
            <label htmlFor="file" className="block text-sm mb-2 font-medium text-[#111827]">
