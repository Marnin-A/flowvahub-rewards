...
export default function ShareYourStack() {
  ...
  const noStack = 'You have no stack created yet, go to Tech Stack to create one.';
    ...
    <MorePointsCard>
      ...
      <div className="p-4">
        <div className="flex items-center justify-between">
          <div>
            <p className="font-normal text-sm text-black">Share your tool stack</p>
          </div>
          <button
          ...
          >
            <h2 className="text-2xl font-bold text-black text-center capitalize mb-4">Share Your Stack</h2>
            <div className="flex items-center justify-center mx-auto bg-secondary-purple rounded-full p-2 w-10 h-10 mb-4">
              <Image src="/icons/stack.svg" alt="stack" height={18} width={16} />
            </div>
